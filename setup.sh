...
if git --git-dir="$DOTFILES_GIT_DIR" --work-tree="$HOME" ls-files --error-unmatch README.md >/dev/null 2>&1; then
    git --git-dir="$DOTFILES_GIT_DIR" --work-tree="$HOME" rm --cached README.md LICENSE setup.sh
fi
